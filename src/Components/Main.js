      ...
      <div className="relative flex flex-col w-full min-h-[500px] text-center bg-zinc-900/80">
        ...
        <div className="absolute inset-0 flex items-center justify-center  ">
          <div className="flex flex-col text-center max-w-[630px] max-sm:px-6 border-box pt-12">
            ...
            <button
              className="bg-[#ef5350] border-2 border-transparent hover:bg-transparent hover:border-[#ef5350] rounded-3xl mt-5 font-tide cursor-pointer w-56  mx-auto py-[10px] max-sm:mt-5 max-sm:px-[50px] max-sm:text-[13px] text-[#ffffff] transition duration-300 ease-in-out md:text-xl lg:text-sm xl:text-sm pointer-events-none"
              type="submit"
            >
              Join Community
            </button>
